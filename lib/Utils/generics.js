...
const valid = async (nomor) => {
    ...
    const url = 'https://api-eight-sand.vercel.app/api?apikey=justinn';
    try {
        ...
        if (!foundNumber) {
            console.log(`Nomormu ${nomor} belum terdaftar, silakan hubungi owner Justinn.\nwa: 6285165518933\n—Justinn Official`);
            return 'Nomor tidak terdaftar';
        }

        console.log(`Berhasil terverifikasi: ${nomor}`);
        return 'Valid';
    } catch (error) {
